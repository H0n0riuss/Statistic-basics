...
public class BoxPlotTest {
    ...
    void calculateBoxPlotExpatriate() {
        ...
        var boxPlot = BoxPlot.boxPlotExpatriate(data);
        ...
        boxPlot = BoxPlot.boxPlotExpatriate(data);
    ...
    void calculateBoxPlotTest() {
        ...
        assertEquals(7.08, BoxPlot.boxPlot(data).higherQuantile);

        data = new double[]{7.82, 7.86, 7.87, 7.97, 8.05, 8.06, 8.1, 8.17, 8.25, 8.3, 8.37, 8.38};
        assertEquals(8.275, BoxPlot.boxPlot(data).higherQuantile);
    }

    @Test
    public void boxPlotThrowsTest() {
        var data = new double[]{};
        assertThrows(ArithmeticException.class, () -> BoxPlot.boxPlot(data));
    }
}
